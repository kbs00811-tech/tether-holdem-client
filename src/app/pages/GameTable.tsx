...
export default function GameTable() {
  ...
  // Portrait (모바일)
  // V20: GG포커 모바일 좌표
  // 🚨 fix(2026-04-28): ToT 회의 결과 — 좌측 좌석이 커뮤니티 카드 가리는 문제
  //   좌석을 더 바깥/위로 조정 + 좌우대칭 합=100 유지
  //   변경: [1] (12,78)→(10,80) / [2] (4,52)→(2,50) / [3] (8,24)→(3,18)
  //         [6] (92,24)→(97,18) / [7] (96,52)→(98,50) / [8] (88,78)→(90,80)
  const HERO_LAYOUT_9_PORTRAIT: [number, number][] = [
    [50,  88],    // 0: hero
    [10,  80],    // 1: bottom-left
    [2,   50],    // 2: left
    [3,   18],    // 3: upper-left  ← 카드와 거리 확보
    [32,  6],     // 4: top-left
    [68,  6],     // 5: top-right
    [97,  18],    // 6: upper-right ← 좌우대칭
    [98,  50],    // 7: right
    [90,  80],    // 8: bottom-right
  ];
